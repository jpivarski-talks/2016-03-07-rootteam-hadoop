...
It's not uncommon to use several frameworks at once, whether they're orthogonal or not. These are the ones I used or heard about most often.

(The fact that almost all of these are Apache doesn't imply similarity.)
...
It's also not uncommon to mix file formats.
