...
Hadoop itself is a mess: user code must be compiled against a Hadoop version, the version history is complex and branches (0.23 is newer than 1.0), that JAR must include dependencies but not include Hadoop, common features like secondary sorting are actually just common user hacks\ldots
