...
map<K,vector<V>> groupByKey(iterator<pair<K,V>>)
map<K,V> reduceByKey(iterator<pair<K,V>>, function<V(V,V)>)
map<K,Z> aggregateByKey(iterator<pair<K,V>>, Z, function<Z(V,Z)>, function<Z(Z,Z)>)
\end{verbatim}
