...
\vspace{\baselineskip}
I never saw any interest in the GRID concept of sending jobs ``anywhere.'' Even cloud computing like Amazon Web Services target specific sites, like {\tt us-east-1}, {\tt eu-west-1}, {\tt ap-northeast-1}\ldots
\end{block}
