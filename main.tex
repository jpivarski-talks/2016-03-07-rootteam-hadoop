...
\begin{description}
\item[JSON] and \textcolor{darkblue}{one-JSON-per-line}


\item[Apache Avro] tree-like data with algebraic data types (arrays, maps, records, and unions of primitives).
