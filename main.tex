...
\item[CSV] table of primitives (text).
...
\item[Parquet] similar to Avro, but stored column-wise for rapid access.
\item[Sequence files] structured container of arbitrary binary blobs; hints for Hadoop splitting.
