...
\item Web advertisement recommendation: Python.
...
\item Monitoring auto traffic: Storm real-time processor (which is Clojure, a JVM language, but I wrote my code in Scala).
...
\item Data science startup: most data analyses in R, some in Python, but the web-facing data backbone was strictly Java.
