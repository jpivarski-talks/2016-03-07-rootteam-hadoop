...
\begin{frame}{Apache Software Foundation (ASF)}
...
The ASF\ldots
\begin{itemize}
\item is a non-profit organization.
\item is popular because of business-friendly licensing (no ``copyleft'').
\item owns and copyrights all complete projects but {\it also} contributors retain ownership of their individual contributions.
