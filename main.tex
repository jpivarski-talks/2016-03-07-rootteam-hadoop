...
\vspace{0.5 cm}
Often the only way to access the Hadoop cluster was through a VPN, over a Citrix Receiver to a Windows VM with Putty installed to a Linux head node (``ship in a bottle''). This discouraged the use of GUIs.
